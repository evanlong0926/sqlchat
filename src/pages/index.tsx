...
const IndexPage: NextPage = () => {
  return (
    <div>
      <Head>
        <title>
          Chat database - Chat-based SQL Client and Editor for the next decade
        </title>
        <meta
          name='description'
        ...
        <meta name='og:title' property='og:title' content='Chat database' />
        <meta
          name='og:description'
      ...
      <h1 className='sr-only'>Chat database</h1>
